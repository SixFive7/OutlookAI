...
- Improve folder listing: it now always returns the complete folder tree of a mailbox (no depth setting to get wrong) in a stable order, with paging available in the unlikely case a profile exceeds 500 folders.
