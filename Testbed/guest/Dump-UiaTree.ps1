...
if ($matched -eq 0) {
    ...
    Emit ''
    Emit 'READ THE AutomationId COLUMN. Non-empty numbers plus Framework="Win32" means route C'
    Emit 'is viable and this dump is the spec. Empty ids, or Framework="DirectUI", means it is not.'
}
