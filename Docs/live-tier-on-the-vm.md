...
7. makes the tier profile the default again, starts Outlook, and on the indexed guest runs
   `corpus-indexed` until the index holds every item of the new population;
